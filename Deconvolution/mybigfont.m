function mybigfont(hdaddy,fontsize,fontweight,tickflag,fontcolor)
%
...
if(~isempty(fontcolor))
    ...
    if tickflag
        myfontsize=1.5;
        setFontPropertiesNoColor(haxes,'axes',get(haxes,'fontsize'),myfontsize,fontweight);
        setFontPropertiesNoColor(hlegend,'legend',get(hlegend,'fontsize'),myfontsize,fontweight);
