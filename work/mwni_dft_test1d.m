function [data,h,F,weights]=mwni_dft_test1d(doplot,method,dftop,firstfig)
...
if (1)
    ...
    print -dpng ../figures/FHF_dft_w.png;
...
if (printing == 1)
if (dftop == 'yes')
    figure(1);print -dpng ../figures/data_orig_dft.png;
    figure(3);print -dpng ../figures/spectra_dft.png;
    figure(4);print -dpng ../figures/data_pred_dft_reg.png;
    figure(5);print -dpng ../figures/data_pred_dft_irreg.png;
    figure(6);print -dpng ../figures/data_pred_dft_orig.png;
else 
    figure(1);print -dpng ../figures/data_orig_fft.png;
    figure(3);print -dpng ../figures/spectra_fft.png;
    figure(4);print -dpng ../figures/data_pred_fft_reg.png;
    figure(5);print -dpng ../figures/data_pred_fft_irreg.png;
    figure(6);print -dpng ../figures/data_pred_fft_orig.png;
end
end
model2= modelreg;
model2(map)=0;
