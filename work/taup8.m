...
ntgap=2;    % Number of traces missed 
nh0=30;     % Number of initial traces (nh-ntgap)
nh1=34;     % Number of final traces (nh0+ntgap+n_interp)
NZ=20;		% Number of near traces to skip

% Take only part of the data to try interpolation

[u,h0,h1,HH,WU0,WU1]=seltrace(xxc,nh0,nh1,dh,h_near,ntgap,NZ);
h_near=h0(1);
clear xxc;
...
NITER=18; % Maximum number of iterations for non-linear problem
