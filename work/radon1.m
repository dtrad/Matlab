function [data_out,offset_axis,time_axis,vr,pp_axis,vrorig]=radon1(u,h0,h1,dt,pnorm,optionp,vel_min,np,NITER,hyperparameter,vel_max,optionmute,freqint,option_residuals)
...
[V,JPF,J,JD,JP]=radonf1(UH,V,epsilon,NITER,tolmodel,pnorm,hyperparameter,C,w,h0,nt,Power,WV,WU0,W,np,alfa,freqint);
