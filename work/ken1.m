...
Daniel,
	...
	I'm sending you some Matlab files to test out the internal multiple 
   prediction algorithm. 
   The file dtrad_export.m contains the commands to build some test data 
   and compute the multiple estimate. 
...
X-Sun-Data-Name: dtrad_export.m
X-Sun-Charset: us-ascii
