...
figure(2);
%colormap(jet);
subplot(321);imagesc(ARD);colorbar;xlabel('(a)');
subplot(322);imagesc(ARG);colorbar;xlabel('(b)');
subplot(323);imagesc(AID);colorbar;xlabel('(c)');
subplot(324);imagesc(AIG);colorbar;xlabel('(d)');
subplot(325);imagesc(ABD);colorbar;xlabel('(e)');
subplot(326);imagesc(ABG);colorbar;xlabel('(f)');
