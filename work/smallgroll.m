function [d2,d,d0,wd,twd]=smallgroll(perc,method,noise);
...
N=128
[x]=readsudata('/home/dtrad/work/smalldatagr.bin',N,N);
...
figure(1); 
subplot(321); imagesc(d0);colorbar;
title('data');
title('(a)');

subplot(322),imagesc(d);colorbar;
title('noisy data');
title('(b)');
...
%   title('ridgelet coeff. after thresholding');
    ...
    subplot(325); imagesc(d2);colorbar;
    %itle(text1);
    title('(e)');
    
    subplot(326); imagesc(d-d2);colorbar;
    %itle('cleaned data.');
    title('(f)');
    if (fig) 
...
% write data for su 
if (1) 
  writesudata('/home/dtrad/work/smalldatagr.b.bin',d);
  writesudata('/home/dtrad/work/smalldatagr.noise.bin',d2);
  writesudata('/home/dtrad/work/smalldatagr.rec.bin',d-d2);
  writesudata('/home/dtrad/work/smalldatagr.ridge.bin',wd);
  writesudata('/home/dtrad/work/smalldatagr.ridgethresh.bin',twd);
end
