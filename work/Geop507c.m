% Tomography problem: Geop507- Exercise 5
...
% 
% 
% The inversion is carried out by setting the problem as underdetermined.
% with weight matrices for the model, first derivative alog x, and first derivative
% along z.
% Daniel Trad
...
% Total cost function
Wm=sqrt(alfas)*Wms+sqrt(alfax)*Wmx+sqrt(alfay)*Wmy;
%Wm=eye(length(mc(:)));
%norm(Wm*vc(mc));
beta0=1;beta1=8;
