function [v,p,h]=xt2taup(u,option1,h,p,dt)
% Forward Transform: v=Lu or v=FWU.u
% 		[v,p,h]=xt2taup(u,option1,h,p,dt)
...
if nargin<4|isempty(p) dp=1e-5;p=(0:nh-1+10).*dp;end
if nargin<3|isempty(h) dh=25;h=(0:nh-1).*dh;end
