...
% [out]=duplic2d(in)
% Given half of the 2D spectrum it duplicates the data to recover the full spectrum 
% mapping 3rd from 1st quadrant and 2nd from 4th
