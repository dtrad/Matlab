...
z=seis_shape(xxc(1:512,1:50));clear data;
z=normalize(z);
%dh=25;
...
pnorm=1;
option='Yilmaz ';
vel_min=2000;vel_max=4000;
np=80;dp=1/vel_min/np;
niter=8;
hyperparameter=1e-3;  %Use 1e-2 for pnorm=1; 1e+2 for pnorm=2
optionmute='y';
freqint=[2 127];
option_residuals='n';

[u,haxis,ttaxis,vr,ppaxis,vrorig]=interp_taup1(x,h0,h1,dt,pnorm,option,vel_min,np,niter,hyperparameter,vel_max,optionmute,freqint,option_residuals);
