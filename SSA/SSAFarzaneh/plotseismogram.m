function plotseismogram (a,scal,x,z,amx)
figure
%plotseismogram: Plot seismic data using wiggles
%
%  plotseismogram(a,scal,x,z,amx) 
%
%  IN    a: seismic data
...
if (nargin <= 2); x=[1:nx]; z=[1:nz]*0.002; end;
...
xlabel('Number of traces ','FontSize',10,'FontWeight','bold')
ylabel('Time (s)','FontSize',10,'FontWeight','bold')
set(gca, 'FontSize',10,'FontWeight','bold')
% set(gca, 'PlotBoxAspectRatio',[1 .8 1])
